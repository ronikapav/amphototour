...
const VideoSection = () => (
  <section id="video-section" className="fullsize-video-bg">
    ...
    <div className="video-excerpt video-card">
            ...
            <p className='video-p'>На этом сайте вы можете получить знания на моих мастер-классах, где я покажу вам самые интересные и эффективные авторские приемы съемки и обработки пейзажных фотографий.
            Также вы можете присоединиться к моим фототурам, в которых я провожу большую часть года вот уже 10 лет.
            Вас ждут захватывающие и живописные места: от классических экспедиций по Алтаю и Курилам до экзотических приключений в Индии и величественных горных районов Китая.</p>
    </div>
    {/* </div> */}
